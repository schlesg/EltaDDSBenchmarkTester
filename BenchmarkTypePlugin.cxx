...
{
    try {
        BenchmarkMessageType *sample = new BenchmarkMessageType;    
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&rti::topic::dynamic_type<BenchmarkMessageType>::get().native()
        ,
        &programProperty,
    ...
    dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        (RTIXCdrTypeCode *)&rti::topic::dynamic_type<BenchmarkMessageType>::get().native()
        ;
...
{ 
    ...
    BenchmarkMessageTypePlugin_get_sample;
    ...
    */
    ...
    BenchmarkMessageTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    BenchmarkMessageTypePlugin_return_buffer;
